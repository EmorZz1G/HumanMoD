...
import tqdm
import argparse
from transformers import AutoTokenizer, BertForSequenceClassification, LlamaTokenizer, LlamaForCausalLM
...
def args_parser():
    ...
    parser.add_argument("--ref_path", type=str, default='/share/home/202320143730/models/CONNER/emnlp_data/nq/random_testset/nq_test_random_testset.txt')
    parser.add_argument("--hyp_path", type=str, default='/share/home/202320143730/models/CONNER/emnlp_data/nq/random_testset/nq_test_random_hyp')
    parser.add_argument("--model_path", type=str, default='/share/home/202320143730/models/monobert-large-msmarco')
...
if __name__ == '__main__':
    ...
    with open('/share/home/202320143730/models/med-proj/LLM_YL/CONNER/log/relevance/pub_rel', 'w') as w:
        for prob in probs:  # 遍历一维张量中的概率值
