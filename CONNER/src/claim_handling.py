...
'''
Five types of important entities:
Organizations, Personal Names, Events, Products, Artworks

Two types of non-critical entities:
Cardinal Numbers indicate the quantity of something.
Ordinal Numbers denote the position or rank of something within a sequence.
